...
| **APIs / Backend** | Docker container hosted on Azure. Handles game logic, user management, question generation and llm service. Communicates with the MongoDB database.
