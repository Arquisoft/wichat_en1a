...
The deployment url is: [https://arquisoft.github.io/wichat_en1a/](https://arquisoft.github.io/wichat_en1a/).
...
If we want to deploy it to GitHub pages, so it is accessible via [https://arquisoft.github.io/wichat_en1a/](https://arquisoft.github.io/wichat_en1a/), we need to execute `npm run deploy`.
