...
| **Game Service** | Contained in the `gameservice` subfolder. Accessed via HTTPS from the backend to store game scores and provide information for the users statistics and leaderboards.
